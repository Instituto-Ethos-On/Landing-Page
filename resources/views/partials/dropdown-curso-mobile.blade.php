<div id="accordion-collapse" data-accordion="collapse">
    <h2 id="accordion-collapse-heading-1">
        <button type="button"
            class="flex items-center w-full p-5 font-bold rtl:text-right text-teal-500 focus:text-teal-700 hover:bg-gray-100 gap-3"
    ...
    <h2 id="accordion-collapse-heading-2">
        <button type="button" class="flex items-center w-full p-5 font-bold rtl:text-right text-teal-500 gap-3"
            ...
            <a href="/educacao" class="p-5 flex justify-center">
                <div id="dropdown-img-12" data-bgimage="images/cards/educacao.jpg"
                    ...
                    <div class="p-5 bottom-0 absolute drop-shadow text-semibold">
                        ...
                        <p>Fique um passo à frente da concorrência, conquiste sua promoção através de um currículo de
                            excelência.</p>
                    </div>
                </div>
            </a>
